...
$classes = $CI->bootcamp_model->get_table('bootcamp_live_class', 'module_id-' . $module_id, 'asc')->result_array();
?>
                            ...
                            <div class="bg-dragula p-2 p-lg-4">
                                ...
                                <div id="section-list" class="py-2">
                                    <?php foreach ($classes as $class) : ?>
                                        <div class="card mb-0 mt-2 draggable-item" id="<?php echo $class['id']; ?>">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <h5 class="mb-1 mt-0"><?php echo $class['title']; ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    function sort() {
        ...
        $.ajax({
            url: '<?php echo site_url('addons/bootcamp/live_class/update_sorted_modules'); ?>',
            type: 'POST',
            data: {
                itemJSON: itemJSON
            },
