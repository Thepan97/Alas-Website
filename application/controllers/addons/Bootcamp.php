...
class Bootcamp extends CI_Controller
{
    ...
    function list()
    {
        ...
        $page_data['page_url'] =  "bootcamp_list";
    ...
    function action($action, $param = '')
    {
        ...
        if ($action == 'form') {
            ...
            $page_data['page_url'] =  "bootcamp_form";
    ...
    function bootcamp_list($uri_sagement = 0)
    {
        ...
        $page_data['page_name'] = 'bootcamp_list';
        $page_data['page_url'] =  "bootcamp_list";
        $page_data['page_title'] = 'Tuition center';
    ...
    function details($id)
    {
        ...
        $page_data['page_url'] =  "bootcamp_details";
    ...
    function my_bootcamp($param = '')
    {
        if ($param == '') {
            ...
            $page_data['page_url'] =  "my_bootcamp";
            $page_data['page_title'] = site_phrase('my_tuition_center');
            ...
            $page_data['page_url'] =  "my_bootcamp_details";
            $page_data['page_title'] = site_phrase('my_tuition_center');
