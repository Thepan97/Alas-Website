        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="bootcamps my-course-1-full-body">
                    <h1 class="mt-4"><?php echo get_phrase('Tuition Center'); ?></h1>
