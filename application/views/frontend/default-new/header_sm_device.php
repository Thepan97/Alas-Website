  ...
  <div class="offcanvas offcanvas-start bg-light" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
    ...
    <div class="offcanvas-body p-0">
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0 pt-5" id="mobile_menubar">
          <?php if($user_login): ?>
          ...
          <li class="bg-light">
            <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500 collapsed" data-bs-toggle="collapse" data-bs-target="#menu_01" aria-expanded="false"><a href="<?php echo site_url('page/in-person-classes'); ?>"> In-person Classes</a>
             
            </button>
            <div class="collapse" id="menu_01">
          ...
          <li class="bg-light">
            <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500 collapsed" data-bs-toggle="collapse" data-bs-target="#menu_02" aria-expanded="false"><a href="<?php echo site_url('page/online-classes'); ?>">Online Classes</a>
             
            </button>
            <div class="collapse" id="menu_02">
              <a href="<?php echo site_url('page/in-person-classes'); ?>#section_01">What we offer</a>
                <a href="<?php echo site_url('page/in-person-classes'); ?>#section_02">Pricing</a>
                <a href="<?php echo site_url('page/in-person-classes'); ?>#section_03">Special offers</a>
            </div>
              ...
              <li class="bg-light">
            <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500 collapsed" data-bs-toggle="collapse" data-bs-target="#menu_03" aria-expanded="false"><a href="<?php echo site_url('page/child-care'); ?>">Childcare</a>
             
            </button>
            <div class="collapse" id="menu_03">
          ...
          <?php if (addon_status('bootcamp')) : ?>
            <li class="bg-light">
              <a href="<?php echo site_url('addons/bootcamp/bootcamp_list'); ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500"> <i class="fab fa-centercode me-2"></i> <?php echo get_phrase('Tuition Center'); ?></a>
            </li>
          <?php endif; ?>
