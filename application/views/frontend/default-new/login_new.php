 <section class="sign-up my-5 pt-5 pb-5">
        <div class="container ">
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12 col-12 m-auto">
                    ...
                    <form action="<?php echo site_url('login/new_validate_login') ?>" method="post">
                        ...
                        <div class="log-in">
                            ...
                            <a class="text-end text-muted" href="<?php echo site_url('login/forgot_password_request'); ?>"><?php echo get_phrase('Forgot password?'); ?></a>
                        </div>
                    </form>
