                            ...
                            <div class="scrollable-tab-section" id="basicwizard">
                                ...
                                <ul class="list-inline mb-0 wizard text-center">
                                    <li class="previous list-inline-item">
                                        <a href="javascript:;" class="btn btn badge-primary-lighten"> <i class="mdi mdi-arrow-left-bold"></i> </a>
                                    </li>
                                    <li class="next list-inline-item">
                                        <a href="javascript:;" class="btn btn badge-primary-lighten"> <i class="mdi mdi-arrow-right-bold"></i> </a>
                                    </li>
                                </ul>
