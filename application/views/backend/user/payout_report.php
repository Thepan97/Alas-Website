...
<div class="row ">
    <div class="col-xl-12 mb-3">
        <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('payout_report'); ?>
            <a href = "javascript:void(0)" class="btn badge-primary-lighten btn-rounded alignToTitle" onclick="showAjaxModal('<?php echo site_url('modal/popup/request_withdrawal'); ?>', '<?php echo get_phrase('request_a_new_withdrawal'); ?>')"><i class="mdi mdi-plus"></i><?php echo get_phrase('request_a_new_withdrawal'); ?></a>
        </h4>
    </div><!-- end col-->
</div>
...
<div class="row justify-content-center">
    <div class="col-lg-4">
        <div class="card badge-danger-lighten" style="border-radius: 10px; ">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                     <h5 class="font-weight-normal mt-0" title="<?php echo get_phrase('pending_amount'); ?>"><?php echo get_phrase('pending_amount'); ?></h5>
                <h3 >
                    <span><i class="mdi mdi-arrow-down-bold"></i></span>
    ...
    <div class="col-lg-4 pull-right">
        <div class="card badge-success-lighten" style="border-radius: 10px; ">
            <div class="card-body d-flex justify-content-between align-items-center">

                <div>
                     <h5 class="font-weight-normal mt-0" title="<?php echo get_phrase('total_payout_amount'); ?>"><?php echo get_phrase('total_payout_amount'); ?></h5>
                    <h3 >
                        <span><i class="mdi mdi-arrow-down-bold"></i></span>
    ...
    <div class="col-lg-4 pull-right">
        <div class="card badge-primary-lighten" style="border-radius: 10px; ">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                       <h5 class="font-weight-normal mt-0" title="<?php echo get_phrase('requested_withdrawal_amount'); ?>"><?php echo get_phrase('requested_withdrawal_amount'); ?></h5>
                    <?php if ($requested_withdrawal_amount > 0): ?>
                        <h3 class="mt-3"><span><i class="mdi mdi-arrow-down-bold"></i></span> <?php echo currency($requested_withdrawal_amount); ?></h3>
                    ...
                    <?php else: ?>
                        <h3 ><span><i class="mdi mdi-arrow-down-bold"></i></span> <?php echo currency_code_and_symbol().''.$requested_withdrawal_amount; ?></h3>
                    <?php endif; ?>
                </div>
                <div class="icon_box">
    ...
    <div class="col-xl-12">
        <div class="card dash_card">
            <div class="card-body">
                ...
                <div class="table-responsive-sm mt-4 custom_table">
