...
<div class="row ">
  <div class="col-xl-12 mb-3">
    <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('theme_settings'); ?>
          <a href="https://academy-lms.com/themes" target="_blank" class="btn badge-primary-lighten btn-rounded alignToTitle ml-3"> <i class="mdi mdi-cart"></i> <?php echo get_phrase('buy_new_theme'); ?></a>
          <a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('admin/upload_theme') ?>', '<?php echo get_phrase('upload_your_theme_file'); ?>');" class="btn badge-primary-lighten btn-rounded alignToTitle"> <i class="mdi mdi-upload"></i> <?php echo get_phrase('upload_your_theme_file'); ?></a>
        </h4>
  </div><!-- end col-->
</div>
