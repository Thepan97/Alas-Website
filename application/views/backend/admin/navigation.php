...
<div class="left-side-menu left-side-menu-detached">
	...
	<!-- <div class="leftbar-user">
		<a href="javascript: void(0);">
			<img src="<?php echo $this->user_model->get_user_image_url($this->session->userdata('user_id')); ?>" alt="user-image" height="30" class="rounded-circle shadow-sm">
			<?php
			...
			<span class="leftbar-user-name">
				...
				<?php
			        ...
			        ?>
			        <span class="account-user-name"><?php echo $logged_in_user_details['first_name'] . ' ' . $logged_in_user_details['last_name']; ?></span><br>
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<?php if (addon_status('bootcamp')) : ?>
			<li class="side-nav-item <?php if ($page_name == 'bootcamp_list' || $page_name == 'bootcamp_form' || $page_name == 'bootcamp_payment_invoice') : ?> active <?php endif; ?>">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'bootcamp_form' || $page_name == 'bootcamp_list' || $page_name == 'bootcamp_payment_invoice') : ?> active <?php endif; ?>">
					...
					<span> <?php echo get_phrase('Tuition Center'); ?> </span>
					<span class="menu-arrow"></span>
				</a>
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<li class="<?php if ($page_name == 'bootcamp_live_classes') echo 'active'; ?>">
						<a href="<?php echo site_url('addons/bootcamp/list'); ?>"><?php echo get_phrase('Tuition Center list'); ?></a>
					</li>

					<!-- add bootcamp -->
					<li class="<?php if ($page_name == 'bootcamp_bootcamp_form') echo 'active'; ?>">
						<a href="<?php echo site_url('addons/bootcamp/action/form'); ?>"><?php echo get_phrase('add Tuition Center'); ?></a>
					</li>
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<li class="<?php if ($page_name == 'course_affiliation_history') echo 'active'; ?>">
						<a href="<?php echo site_url('addons/affiliate_course/course_affiliation_history'); ?>">
							...
							<span class="badge badge-danger rounded-circle d-inline-flex align-items-center justify-content-center" style="width:20px;height:20px;font-size:10px;margin: 0;vertical-align: text-bottom;"></span>
						</a>
					</li>
							...
							<ul class="side-nav-third-level" aria-expanded="false">
								...
								<li class="<?php if ($page_name == 'instructor_payout') echo 'active'; ?>">
									<a href="<?php echo site_url('admin/instructor_payout'); ?>">
										...
										<span class="badge badge-danger rounded-circle d-inline-flex align-items-center justify-content-center" style="width:20px;height:20px;font-size:10px;margin: 0;vertical-align: text-bottom;"><?php echo $this->crud_model->get_pending_payouts()->num_rows(); ?></span>
									</a>
								</li>
								...
								<li class="<?php if ($page_name == 'application_list') echo 'active'; ?>">
									<a href="<?php echo site_url('admin/instructor_application'); ?>">
										...
										<span class="badge badge-danger rounded-circle d-inline-flex align-items-center justify-content-center" style="width:20px;height:20px;font-size:10px;margin: 0;vertical-align: text-bottom;"><?php echo $this->user_model->get_pending_applications()->num_rows(); ?></span>
									</a>
								</li>
							</ul>
						</li>
		...
		<?php if (has_permission('messaging')) : ?>
			<!----
			<li class="side-nav-item ">
				<a href="<?= site_url('admin/message'); ?>" class="side-nav-link <?php if ($page_name == 'message' || $page_name == 'message_new' || $page_name == 'message_read') echo 'active'; ?>">

					<i class="dripicons-message"></i>

					<span><?php echo get_phrase('message'); ?></span>

					<div class="d-inline-flex" style="vertical-align: middle;margin-left: 10px;">
						<img src="<?=site_url('uploads/user_image/avatar.png');?>" height="20">
						<img src="<?=site_url('uploads/user_image/avatar2.png');?>" height="20" style="margin-left:-5px;">
						<img src="<?=site_url('uploads/user_image/avatar3.png');?>" height="20" style="margin-left:-5px;">
					</div>
					...
					<?php if ($unreaded_message > 0) : ?>
						<span class="badge badge-danger rounded-circle d-inline-flex align-items-center justify-content-center" style="width:20px;height:20px;font-size:10px;margin: 0;vertical-align: text-bottom;"><?php echo $unreaded_message; ?></span>
					<?php endif; ?>
				</a>
			</li>
			---->
			...
			<li class="side-nav-item <?php if ($page_name == 'blog' || $page_name == 'blog_add' || $page_name == 'blog_edit' || $page_name == 'blog_category' || $page_name == 'blog_settings') : ?> active <?php endif; ?>">
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<li class="<?php if ($page_name == 'instructors_pending_blog') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/instructors_pending_blog'); ?>"><?php echo get_phrase('pending_blog'); ?> <span class="badge badge-danger rounded-circle d-inline-flex align-items-center justify-content-center" style="width:20px;height:20px;font-size:10px;margin: 0;vertical-align: text-bottom;"><?php echo $this->crud_model->get_instructors_pending_blog()->num_rows(); ?></span></a>
					</li>
