<div class="row ">
    <div class="col-xl-12 mb-3">
        <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
            <a href="<?php echo site_url('admin/admins'); ?>" class="btn badge-primary-lighten btn-rounded alignToTitle"> <i class="mdi mdi-arrow-left"></i> <?php echo get_phrase('back_to_admins'); ?></a>
        </h4>
    </div><!-- end col-->
</div>
<div class="row">
