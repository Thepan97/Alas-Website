...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom_table dash_card table-responsive-sm mt-3">
              ...
              <div class="row justify-content-md-center mt-3">
                  <div class="col-xl-6">
                      <form class="form-inline" action="<?php echo site_url('admin/enrol_history/filter_by_date_range') ?>" method="get">
                          ...
                          <div class="col-xl-2">
                              <button type="submit" class="btn btn-primary" id="submit-button" onclick="update_date_range();"> <?php echo get_phrase('filter');?></button>
                          </div>
                      </form>
                  </div>
              </div>
                          ...
                          <tbody>
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  <tr class="gradeU">
                                      ...
                                      <td>
                                          <button type="button" class="btn badge-danger-lighten btn-icon btn-sm" onclick="confirm_modal('<?php echo site_url('admin/enrol_history_delete/'.$enrol['id']); ?>');"> <i class="dripicons-trash"></i> </button>
                                      </td>
                                  </tr>
                              <?php endforeach; ?>
                          </tbody>
