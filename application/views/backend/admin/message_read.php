	            ...
	            <div class="chat-conversation">
	                ...
	                <form method="post" action="<?php echo site_url('admin/message/send_reply/'.$current_message_thread_code); ?>" class="needs-validation" novalidate name="chat-form" id="chat-form">
	                    <div class="row send_message">
	                        <div class="col">
	                            <input type="text" name="message" class="form-control chat-input" placeholder="Write your Message" required>
	                            <div class="invalid-feedback">
		                            <?php echo get_phrase('Please enter your messsage'); ?>
		                        </div>
	                            <button type="submit" class="btn btn-danger chat-send btn-block waves-effect waves-light"><i class="dripicons-message"></i> <?php echo get_phrase('send'); ?></button>
	                        </div>
