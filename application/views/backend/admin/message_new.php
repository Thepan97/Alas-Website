...
<div class="message_box">
	...
	<div class="card-body">
		<span><?php echo get_phrase('write_new_messages');?></span>
		<form method="post" class="mt-2" action="<?php echo site_url('admin/message/send_new'); ?>" enctype="multipart/form-data">
		    ...
		    <div class="form-group mb-2">
		        <div class="row">
		            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		                <textarea class="form-control badge-success-lighten" rows="5" name="message" id="message" placeholder="<?php echo get_phrase('type_your_message'); ?>" required></textarea>
		            </div>
		        </div>
		    </div>
