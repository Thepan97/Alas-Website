<div class="row ">
  <div class="col-xl-12 mb-3">
    <h4 class="page-title"> <i class="mdi mdi-web title_icon"></i> <?php echo get_phrase('custom_pages'); ?>
          <a href="<?php echo site_url('admin/add_custom_page'); ?>" class="btn badge-primary-lighten btn-rounded alignToTitle mr-1"><i class="mdi mdi-plus"></i> <?php echo get_phrase('add_a_new_page'); ?></a>
        </h4>
  </div><!-- end col-->
</div>
...
<div class="row justify-content-center">
  <div class="col-xl-12">
    <div class="custom_table dash_card">
      <div class="card-body ">
