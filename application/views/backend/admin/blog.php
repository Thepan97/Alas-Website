<div class="row ">
    <div class="col-xl-12 mb-3">
        <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('blogs'); ?>
            <a href="<?php echo site_url('admin/add_blog'); ?>" class="btn badge-primary-lighten btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_blog'); ?></a>
        </h4> <!-- end card -->
    </div><!-- end col-->
</div>
    ...
    <div class="col-xl-12">
        <div class="card custom_table dash_card">
            <div class="card-body p-0">
                <h4 class="header-title p-3"><?php echo get_phrase('blogs'); ?></h4>
                <div class="table-responsive-sm ">
                    <table id="basic-datatable" class="table table-striped table-centered mb-0 dataTable no-footer">
                        <thead>
                            <tr>
                                <th>#</th>
