...
<div class="row justify-content-center">
    <div class="col-xl-12">
        <div class="card dash_card">
            <div class="card-body custom_padd">
                ...
                <div class="scrollable-tab-section" id="basicwizard">
                    ...
                    <div class="scrollable-tab" style="height: 50px; overflow-y: hidden;">
                        ...
                        <ul class="form-wizard-header nav nav-pills nav-justified mb-3" style="width: fit-content;">
                            <li class="nav-item">
                    ...
                    <div class="tab-pane show active" id="frontendsettings">
                        ...
                        <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="banner_sub_title" id = "banner_sub_title" class="form-control" rows="5" required><?php echo get_frontend_settings('banner_sub_title');  ?></textarea>
