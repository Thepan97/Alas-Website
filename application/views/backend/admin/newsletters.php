<div class="row ">
  <div class="col-xl-12 mb-4">
     <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
          <a href="#" onclick="showAjaxModal('<?php echo site_url('admin/newsletter_add_form'); ?>', '<?php echo get_phrase('Newsletter template') ?>')" class="btn badge-primary-lighten btn-rounded alignToTitle"><i class=" mdi mdi-plus"></i> <?php echo get_phrase('Newsletter'); ?></a>
        </h4>
  </div><!-- end col-->
</div>
