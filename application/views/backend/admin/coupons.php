    ...
    <div class="col-xl-12 mb-3">
         <h4 class="page-title">
          <!-- <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?> -->
            <a href="<?php echo site_url('admin/coupon_form/add_coupon_form'); ?>" class="btn badge-primary-lighten btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_coupon'); ?></a>
        </h4>
    </div><!-- end col-->
</div>
