...
?>
  ...
  <div class="row justify-content-center">
    <div class="col-xl-9">
      <div class="card dash_card cta-box">
        <div class="card-body">
            ...
            <div class="media-body">
              <div class="chart-widget-list">
                ...
                <p>
                  ...
                  <span class="float-right">
                    <?php if (strtolower($application_details['purchase_code_status']) == 'expired'): ?>
                      ...
                      <a href="#" target="_blank" class="btn btn-success float-right mr-2 py-0"><?php echo get_phrase('renew_support'); ?></a>
                ...
                <p style="margin-top: 8px;">
                  ...
                  <span class="float-right"><a href="#" class="btn btn-warning py-0" target="_blank" style="color: #343a40;"> <?php echo get_phrase('Get Services'); ?> </a> </span>
                </p>
              </div>
            </div>
