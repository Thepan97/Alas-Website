<div class="row top_dashboard_2">

    <div class="col-sm-6 col-xl-3 news">
        <a href="<?php echo site_url('admin/newsletter_history/pending') ?>" class="text-secondary">
            <div class="card dash_card">
                <div class="card-body text-center">
                    ...
                    <p class="font-15 mb-0"><?php echo get_phrase('Total Pending'); ?></p>
                    <small><?php echo get_phrase('Waiting to be sent') ?></small>
                    <h6 class="mb-0"><i class="fas fa-long-arrow-alt-right"></i></h6>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="<?php echo site_url('admin/newsletter_history/sent') ?>" class="text-secondary">
            <div class="card dash_card">
                <div class="card-body text-center">
                    ...
                    <p class="font-15 mb-0"><?php echo get_phrase('Total Success'); ?></p>
        ...
        <a href="<?php echo site_url('admin/newsletter_history/faild') ?>" class="text-secondary">
            <div class="card dash_card">
                <div class="card-body text-center">
                    ...
                    <p class="font-15 mb-0"><?php echo get_phrase('Total Faild'); ?></p>
        ...
        <a href="<?php echo site_url('admin/newsletter_history/unable') ?>" class="text-secondary">
            <div class="card dash_card">
                <div class="card-body text-center">
                    ...
                    <p class="font-15 mb-0"><?php echo get_phrase('Unable to send'); ?></p>
